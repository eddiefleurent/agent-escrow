...
This guide covers Phase 3 items 5 and 6: deploying the `TaskEscrowFactory` to Base Sepolia and running a reference agent demo through the full escrow lifecycle.
