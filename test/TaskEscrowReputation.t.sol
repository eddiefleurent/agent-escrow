...
contract TaskEscrowReputationTest is Test {
    ...
    function testApprovalRecordsCompleted() public {
        ...
        vm.prank(worker);
        escrow.submit(keccak256("sub"), "ipfs://sub");
        vm.prank(buyer);
    ...
    function testBackupWorkerGetsReputation() public {
        ...
        escrow.submit(keccak256("backup-sub"), "ipfs://backup-sub");
        vm.prank(buyer);
        escrow.approveByBuyer();
    ...
    function testReputationAccumulates() public {
        ...
        vm.prank(worker);
        escrow1.submit(keccak256("sub1"), "ipfs://sub1");
        vm.prank(buyer);
        ...
        vm.prank(worker);
        escrow2.submit(keccak256("sub2"), "ipfs://sub2");
        vm.prank(verifier);
        ...
        vm.prank(worker);
        escrow3.submit(keccak256("sub3"), "ipfs://sub3");
        vm.prank(buyer);
    ...
    function testMilestoneAllApprovedRecordsCompleted() public {
        ...
        // Approve milestone 1
        vm.prank(worker);
        escrow.submitMilestone(1, keccak256("ms1"), "ipfs://ms1");
        vm.prank(buyer);
